...
public class LoginPage extends BasePage {
    ...
    public void enterUsername(String username) {
        waitForElement(resolveSelector("login.username.selector")).sendKeys(username);
    }
    
    public void enterPassword(String password) {
        waitForElement(resolveSelector("login.password.selector")).sendKeys(password);
    }
    
    public DashboardPage clickLoginButton() {
        waitForElement(resolveSelector("login.button.selector")).click();
